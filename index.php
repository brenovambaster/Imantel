...
<body>
    ...
    <section class="container" id="empresa">
        <div class="empresa_title">
            <h2 class="text-center fonte_h1"> Imantel <br> Soluções em Engenharia</h2>
        </div>

        <div class="row mt-5">
            <div class="col-md-6 text-justify float-left">
                <p>Fundada em 2005, a Conection se apresenta ao mercado como empresa de engenharia elétrica especializada em montagens elétricas para
                    diferentes segmentos, com destaque para subestação, mineração, siderurgia e cimento. Ao longo dos anos consolidou-se nos
                    ramos de engenharia elétrica detalhada, treinamentos, consultoria, fiscalização e supervisão das montagens elétricas.</p>
            </div>
            <div class="col-md-6">
                <div id="carouselExampleCaptions" class="carousel slide rounded-lg rounded-sm" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="imgs/img3.jpg" class="d-block w-100" alt="img3">
                            <div class="carousel-caption d-none d-sm-block">
                                <h5>Projeto de automação comercial</h5>
                                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="imgs/img1.jpg" class="d-block w-100 h-200" alt="img4">
                            <div class="carousel-caption d-none d-sm-block">
